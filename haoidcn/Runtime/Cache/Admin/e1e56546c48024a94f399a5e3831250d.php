...
<!--             	<li class="active"><a href="<?php echo U('Console/dashboard');?>"><span class="iconfa-question-sign"></span> 工单</a></li> -->
                ...
                <li <?php echo ($data["user_block03"]); ?>><a href="<?php echo U('Admin/ticket?case=all');?>"><span class="iconfa-file"></span>工单分配<span class="right"><?php echo ($ticket_count["c_unass"]); ?></span></a></li>
                ...
                <div class="messagepanel">
                    ...
                    <div class="messagecontent main-content">
                        <table class="table table-bordered table-fixed table-tr-click">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr onclick="javascript:window.location.href='<?php echo U('Admin/ticket_detail?case='.$data['case'].'&id='.$vo['id']);?>'">
